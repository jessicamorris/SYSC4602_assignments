...
\item 
% So the answer to this is \frac{\sum_{p=0}^{k-2}\sum_{q=0}^{n-2}(k-p-1)(n-q-1)}{nk(nk-1)(nk-2)(nk-3)} but I gotta prove that besides "hurr durr I wrote a python script"
